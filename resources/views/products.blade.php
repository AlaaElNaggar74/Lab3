...
<div class="container">
    <div class="by my-3">
        <a href="{{route('product.input')}}" class="btn btn-primary">Add products</a>
        ...
        <div class="col-md-4 mb-3">
            <div class="card  mb-3 p-2" >
                ...
                <div class="card-body">
                  ...
                  @if ($product->category)
                  <p class="card-text " ><span class="fw-bold">Category : </span>  <img src="{{asset('/images/categoryLogo/'.$product->category->logo)}}" alt="error" srcset="" class="ms-2"  style="height:50px;width:50px; border-radius:50%; "> </p>
                ...
                <div class="b d-flex justify-content-center ">
                    ...
                    <a href="{{route('product.destroy',$product->id)}}" class="btn btn-danger mx-1" onclick="confirmation(event)">Delete</a>
                    <a href="{{route('product.update',$product->id)}}" class="btn btn-success">Update</a>
                </div>
              </div>
        </div>
        @endforeach
